...
import burgerMix from "@/assets/burger-mix.jpg";
import burgerDouble from "@/assets/burger-double.jpg";
import burgerChicken from "@/assets/burger-chicken.jpg";
import burgerKids from "@/assets/burger-kids.jpg";
import burgerTropic from "@/assets/burger-tropic.jpg";
...
export const products: Product[] = [
  ...
  { id: "fanta-05l", name: "FANTA 0.5 Л", price: 550, category: "drinks", image: fanta05l, items: ["Пластик бөтелке, 0.5 л"] },
  { id: "fuze-mango-05l", name: "FUZE TEA МАНГО 0.5 Л", price: 550, category: "drinks", image: fuzeMango05l, items: ["Манго дәмі, 0.5 л"] },
  { id: "fuze-mango-1l", name: "FUZE TEA МАНГО 1 Л", price: 750, category: "drinks", image: fuzeMango1l, items: ["Манго дәмі, 1 л"] },
  { id: "fuze-peach-05l", name: "FUZE TEA ПЕРСИК 0.5 Л", price: 550, category: "drinks", image: fuzePeach05l, items: ["Шабдалы дәмі, 0.5 л"] },
  { id: "fuze-peach-1l", name: "FUZE TEA ПЕРСИК 1 Л", price: 750, category: "drinks", image: fuzePeach1l, items: ["Шабдалы дәмі, 1 л"] },
  { id: "fuze-chamomile-05l", name: "FUZE TEA РОМАШКА 0.5 Л", price: 550, category: "drinks", image: fuzeChamomile05l, items: ["Түймедақ дәмі, 0.5 л"] },
  { id: "fuze-chamomile-1l", name: "FUZE TEA РОМАШКА 1 Л", price: 750, category: "drinks", image: fuzeChamomile1l, items: ["Түймедақ дәмі, 1 л"] },
  { id: "piko-orange-09l", name: "PIKO АПЕЛЬСИН 0.9 Л", price: 900, category: "drinks", image: pikoOrange09l, items: ["Апельсин шырыны, 0.9 л"] },
  { id: "piko-apple-09l", name: "PIKO ЯБЛОКО 0.9 Л", price: 900, category: "drinks", image: pikoApple09l, items: ["Алма шырыны, 0.9 л"] },
  { id: "piko-02l", name: "PIKO 0.2 Л", price: 350, category: "drinks", image: piko02l, items: ["Шырын, 0.2 л"] },
  { id: "ayran-03l", name: "АЙРАН 0.3 Л", price: 400, category: "drinks", image: ayran03l, items: ["Салқын айран, 0.3 л"] },
  { id: "coca-cola-draft-05l", name: "РАЗЛИВНАЯ COCA-COLA 0.5 Л", price: 600, category: "drinks", image: cocaColaDraft05l, items: ["Құйылмалы сусын, 0.5 л"] },

  // ================= СОУСТАР / SAUCES =================
  { id: "sauce-cheese", name: "СЫРНЫЙ СОУС", price: 200, category: "sauces", image: sauceCheese, items: ["Сырный соус, 1 дана"] },
  { id: "sauce-bbq", name: "БАРБЕКЮ СОУС", price: 200, category: "sauces", image: sauceBbq, items: ["Барбекю соус, 1 дана"] },
  { id: "sauce-ketchup", name: "КЕТЧУП", price: 200, category: "sauces", image: sauceKetchup, items: ["Кетчуп, 1 дана"] },
];
